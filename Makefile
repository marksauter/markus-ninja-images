...
BIN := markus-ninja-images

# The branch we are working in.
BRANCH ?= development

# This repo's root import path (under GOPATH).
PKG := github.com/marksauter/markus-ninja-images
...
watch:
	BRANCH=development.local gin --port 5050 --appPort 5051 -d ./cmd/markus-ninja-images/ run cmd/markus-ninja-images/main.go
